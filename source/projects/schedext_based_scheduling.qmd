...
The idea is to take advantage of tight coupling between Control Plane and the scheduling policy. 
In essence the policy is driven by the metadata of the functions thereby taking advantage of the 
extra information available at the higher layers.
