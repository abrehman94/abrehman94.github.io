...
The idea is that the metadata of the functions available to the Control Plane can be used to hint the 
CPU scheduler to make better scheduling decisions.
With the help of SchedExt framework, we can develop sophisticated scheduling policies that are tightly 
