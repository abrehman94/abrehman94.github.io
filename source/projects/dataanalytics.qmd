...
author:
  - name: Abdul Rehman 
    ...
    email: abdulrehmanee010@gmail.com 
description: >
  Energy Insights In a Box is a data analytics system that can be used to capture and analyze data in real time. The system is designed to be deployed on edge devices like Jetson Orin.
